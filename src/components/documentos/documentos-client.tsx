...
export function DocumentosClient({ documentos }: any) {
  ...
  function handleFile(e: React.ChangeEvent<HTMLInputElement>) {
    ...
    setForm(f => ({ ...f, nome: f.nome || file.name.replace(/\.[^.]+$/, ''), tipo: ext, emoji: TIPO_EMOJI[ext] || '📄' }))
  }
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-4 gap-4">
        ...
        <div className="bg-card border border-dashed border-border rounded-xl p-4 flex flex-col items-center justify-center gap-2 cursor-pointer opacity-50 hover:opacity-80 min-h-[140px]" onClick={openNew}>
